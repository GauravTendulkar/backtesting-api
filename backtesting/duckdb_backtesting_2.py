...
from functions_duckdb.create_files_2 import CreateFiles
...
def duckdb_backtesting_2(data, date_ranges):
    print("duckdb_backtesting_2")
    sl_db.init_table()
    print("Running in process:", os.getpid())
...
#__________________________________________________________
    ...
    # print("backtesting time" , (time.perf_counter_ns() - init)/1000/1000)   
    # # print(Tracking)
